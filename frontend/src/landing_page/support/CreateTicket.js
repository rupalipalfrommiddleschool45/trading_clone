        ...
        <div className='conatiner'>
            <div className='row p-5 mt-5 mb-5 '>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className=''>
                        <i class="fa fa-plus-circle fa-1x" aria-hidden="true"></i>&nbsp;Account Opening
                    </h4>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    ...
                    <a href='#' style={{
                        textDecoration: "none", lineHeight: "2.5"
                    }}>IPO</a><br />
             ...
             coin
                    ...
                    <a href='#' style={{ textDecoration: "none" , lineHeight: "2.5"}}>Com
                    Transactions and reports</a><br />
